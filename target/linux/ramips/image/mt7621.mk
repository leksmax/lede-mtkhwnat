...
define Device/mac2600r
  ...
  IMAGE_SIZE := $(ralink_default_fw_size_16M)
  IMAGE/sysupgrade.bin := append-kernel | append-rootfs | pad-rootfs | append-metadata | check-size $$$$(IMAGE_SIZE)
  DEVICE_TITLE := Mercury MAC2600R V1
endef
TARGET_DEVICES += mac2600r



define Device/mr2600
  DTS := mr2600
  BLOCKSIZE := 64k
  IMAGE_SIZE := 15680k
  KERNEL_INITRAMFS := $$(KERNEL) | motoimage
  IMAGE/sysupgrade.bin := append-kernel | append-rootfs | motoimage | \
	pad-rootfs | append-metadata | check-size $$$$(IMAGE_SIZE)
  DEVICE_TITLE := Motorola MR2600
endef
TARGET_DEVICES += mr2600
...
define Device/mt7621-raeth-nand
$(Device/DefaultFIT)
  DEVICE_DTS := mt7621-raeth-nand
  BLOCKSIZE := 128k
  IMAGE_SIZE := $(ralink_default_fw_size_16M)
  DEVICE_TITLE := MediaTek MT7621 RAETH (NAND)
endef
TARGET_DEVICES += mt7621-raeth-nand
...
define Device/mt7621-rfb-ax-slt
$(Device/DefaultFIT)
  DEVICE_DTS := mt7621-rfb-ax-slt
  BLOCKSIZE := 64k
  IMAGE_SIZE := $(ralink_default_fw_size_16M)
  DEVICE_TITLE := MediaTek MT7621 AX SLT image
endef
TARGET_DEVICES += mt7621-rfb-ax-slt
...
define Device/redmi2100
  ...
  DEVICE_TITLE := redmi2100
endef
TARGET_DEVICES += redmi2100
